...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    MOSQUITO_LEATHER("mosquito_leather", 26, new int[]{ 0, 0, 0, 1 }, 25,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f, () -> Ingredient.of(ModItems.MOSQUITO_LEATHER.get())),

    HAZMAT("hazmat", 26, new int[]{ 1, 3, 3, 2 }, 25,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f, () -> Ingredient.of(ModItems.MOSQUITO_LEATHER.get()));
    ...
    public String getName() {
        return Mosquitos.MODID + ":" + this.name;
    }
